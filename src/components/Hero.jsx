...
const Hero = () => {
    ...
    return (
        <div className="relative h-dvh w-screen overflow-x-hidden">
            <div id="video-frame" className="relative z-10 h-dvh w-screen overflow-hidden rounder-lg bg-blue-50">
              <div>
              ...
              <div className="absolute left-0  top-0 z-40 size-full">
                 <div className="mt-24 px-5 sm:px-10">
                   ...
                   <p className="mb-5 max-w-64 font-robert-regular text-red-500">A 5v5 character-based tactical shooter</p>
